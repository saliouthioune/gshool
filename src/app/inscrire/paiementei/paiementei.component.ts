...
@Component({
  selector: 'app-paiementei',
  templateUrl: './paiementei.component.html',
  styleUrls: ['./paiementei.component.css']
})
export class PaiementeiComponent implements OnInit {
  ...
  nomclasse:any;promo:any;
   ...
   gotoliclasse(){
     return this.router.navigate(['lipaiement'])
   }
